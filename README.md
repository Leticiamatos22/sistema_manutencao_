...
Este é o repositório do Projeto Integrador - Sistema de Gerenciamento de Manutenção, desenvolvido para facilitar o gerenciamento de atividades de manutenção em uma empresa industrial.

## Comando de Criação

Para criar o projeto Next.js, execute o seguinte comando:
...
Para adicionar ícones ao seu projeto, utilize as bibliotecas abaixo:

- [Lucide Icons](https://lucide.dev/)
- [React Icons](https://react-icons.github.io/react-icons/)

Para instalar a biblioteca de ícones:
...
Criar uma aplicação web para gerenciar as atividades de manutenção, otimizando os processos e melhorando a comunicação e a organização dentro da empresa.

### Requisitos Funcionais

- **Cadastro de máquinas:** Incluir informações como nome, tipo, modelo, data de fabricação, número de série, localização, histórico de manutenção.
- **Gerenciamento de Máquinas:** Visualização detalhada de cada máquina, com histórico de manutenções, informações sobre peças e materiais utilizados.
